...
/**
 * @fileoverview
 * Script to pull desktop translations from transifex and generate the scratch_msgs file.
...
const usage = `
 Pull desktop translations from Transifex. Usage:
   node tx-pull-desktop.js path
...
async.mapLimit(Object.keys(locales), CONCURRENCY_LIMIT, getLocaleData, function (err, values) {
    ...
    values.forEach(function (translation) {
        // skip validation as it's handled in scratch-desktop
